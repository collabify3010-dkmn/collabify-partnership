...
;(() => {
    ...
    return `
      ...
      <main class="section" role="main">
        <div class="container">
          ...
          <form class="filters" aria-label="Filter partners">
    ...
    return `
      ...
      <main class="section" role="main">
        <div class="container">
          ...
          <form class="filters" aria-label="Filter opportunities">
            <div class="filters-row">
              <label>
                <span class="label">Industry</span>
  ...
  function addEventListeners() {
    ...
    $$(".filters select, .filters input[type='search']").forEach((el) => {
      el.addEventListener("change", (e) => {
        const filterName = el.closest("form").id.includes("partner") ? "partnerFilters" : "filters"
        state[filterName][el.name] = el.value
        render()
      })
